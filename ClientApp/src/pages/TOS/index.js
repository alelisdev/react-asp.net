        ...
        <div className="main">
            <div className='online-container'>
                ...
                <div className='centered'>
                    ...
                    <p className='title online-title'>TERMS OF SERVICE</p>
                </div>
            </div>
            <div className="container mt-5 mb-5">
                <div className="row justify-content-center">
                    <div className="col-md-9">
                        <div className="sp-desc">Last updated: April 21, 2017</div>
                    </div>
                    <div className="col-md-9 mt-3">
                        <div className="sp-desc">
                        Please read these Terms of Service (“Terms”, “Terms of Service”) carefully before using the https://www.thorapps.com website (the “Service”) operated by Bear Entrepreneurial Group P/L trading as ThorApps (“us”, “we”, or “our”).
...
By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the terms then you may not access the Service.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Purchases</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
...
The Service is not designed to provide qualitative advice regarding the fitness for purpose and merchantability of any products or services. We strongly advise you to exercise caution and do your own due diligence in conducting any transactions through the Service.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Availability, Errors and Inaccuracies</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
...
The content is provided without warranties or conditions of any kind either express or implied, including but not limited to implied warranties and conditions of merchantability, fitness for a particular purpose or non-infringement.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Subscriptions</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
...
At the end of each Billing Cycle, your Subscription will automatically renew under the exact same conditions unless you cancel it or Bear Entrepreneurial Group P/L trading as ThorApps cancels it. You may cancel your Subscription renewal either through your online account management page or by contacting Bear Entrepreneurial Group P/L trading as ThorApps customer support team.

A valid payment method, including credit card, is required to process the payment for your Subscription. You shall provide Bear Entrepreneurial Group P/L trading as ThorApps with accurate and complete billing information including full name, address, state, zip code, telephone number, and a valid payment method information. By submitting such payment information, you automatically authorize Bear Entrepreneurial Group P/L trading as ThorApps to charge all Subscription fees incurred through your account to any such payment instruments.

Should automatic billing fail to occur for any reason, Bear Entrepreneurial Group P/L trading as ThorApps will issue an electronic invoice indicating that you must proceed manually, within a certain deadline date, with the full payment corresponding to the billing period as indicated on the invoice.
                        </div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-title">Free Trial</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
                        Bear Entrepreneurial Group P/L trading as ThorApps may, at its sole discretion, offer a Subscription with a free trial for a limited period of time (“Free Trial”).

You may be required to enter your billing information in order to sign up for the Free Trial.

If you do enter your billing information when signing up for the Free Trial, you will not be charged by Bear Entrepreneurial Group P/L trading as ThorApps until the Free Trial has expired. On the last day of the Free Trial period, unless you cancelled your Subscription, you will be automatically charged the applicable Subscription fees for the type of Subscription you have selected.

At any time and without notice, Bear Entrepreneurial Group P/L trading as ThorApps reserves the right to (i) modify the terms and conditions of the Free Trial offer, or (ii) cancel such Free Trial offer.
                        </div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-title">Fee Changes</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
                        Bear Entrepreneurial Group P/L trading as ThorApps, in its sole discretion and at any time, may modify the Subscription fees. Reasons for referred changes may include increased costs with Microsoft software licenses, hosting, currency changes and CPI index. Bear Entrepreneurial Group P/L trading as ThorApps will provide you with a 3-month prior notice of any increase in Subscription fees to give you an opportunity to negotiate or terminate your subscription before such change becomes effective. A decrease in subscription fees may occur with no prior notice. Any Subscription fee change will become effective at the end of the then-current Billing Cycle.
Your continued use of the Service after the Subscription fee change comes into effect constitutes your agreement to pay the modified Subscription fee amount.
                        </div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-title">Refunds</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Content</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
...
You acknowledge and agree that all Content you provide on the Service will be publicly available information and you bear the risks involved with such public disclosures.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Accounts</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
...
You may not use as a username the name of another person or entity or that is not lawfully available for use, a name or trade mark that is subject to any rights of another person or entity other than you without appropriate authorization, or a name that is otherwise offensive, vulgar or obscene.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Intellectual Property</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
                        The Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of Bear Entrepreneurial Group P/L trading as ThorApps and its licensors. The Service is protected by copyright, trademark, and other laws of both the Australia and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Bear Entrepreneurial Group P/L trading as ThorApps. Nothing in these Terms constitutes a transfer of any Intellectual Property rights from us to you.
...
Any opinions, advice, statements, services, offers, or other information or content expressed or made available by any other users are those of the respective authors or distributors and not of us.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Links To Other Web Sites</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
                        Our Service may contain links to third-party web sites or services that are not owned or controlled by Bear Entrepreneurial Group P/L trading as ThorApps.

Bear Entrepreneurial Group P/L trading as ThorApps has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that Bear Entrepreneurial Group P/L trading as ThorApps shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.
...
We strongly advise you to read the terms and conditions and privacy policies of any third-party web sites or services that you visit.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Termination</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
...
If applicable law requires us to provide notice of termination or cancellation, we may give prior or subsequent notice by posting it on the Service or by sending a communication to any address (email or otherwise) that we have for you in our records.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Indemnification</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
...
This indemnification section survives the expiration of your registration, and applies to claims arising both before and after the registration ends.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Limitation Of Liability</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
...
Without limiting the foregoing, in no event will our aggregate liability to you exceed, in total, the amounts paid by you to us.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Disclaimer</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
                        Your use of the Service is at your sole risk. The Service is provided on an “AS IS” and “AS AVAILABLE” basis. The Service is provided without warranties of any kind, whether express or implied, including, but not limited to, implied warranties of merchantability, fitness for a particular purpose, non-infringement or course of performance.

Bear Entrepreneurial Group P/L trading as ThorApps its subsidiaries, affiliates, and its licensors do not warrant that a) the Service will function uninterrupted, secure or available at any particular time or location; b) any errors or defects will be corrected; c) the Service is free of viruses or other harmful components; or d) the results of using the Service will meet your requirements.
...
We make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability or availability with respect to the content contained on the Service for any purpose. Any reliance you place on such information is therefore strictly at your own risk. We disclaim any express or implied warranty representation or guarantee as to the effectiveness or profitability of the Service or that the operation of our Service will be uninterrupted or error-free. We are not liable for the consequences of any interruptions or error in the Service.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Exclusions</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Governing Law</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
...
Our failure to enforce any right or provision of these Terms will not be considered a waiver of those rights. If any provision of these Terms is held to be invalid or unenforceable by a court, the remaining provisions of these Terms will remain in effect. These Terms constitute the entire agreement between us regarding our Service, and supersede and replace any prior agreements we might have between us regarding the Service.
                    ...
                    <div className="col-md-9">
                        <div className="sp-title">Changes</div>
                    </div>
                    <div className="col-md-9">
                        <div className="sp-desc">
